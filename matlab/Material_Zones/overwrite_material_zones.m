...
input_file = '../../models/SCERM_v5/Geo/Swan_Canning_v3_001_Seagrass_Fremantle_NS_v3_BC.2dm';
output_file = '../../models/SCERM_v5/Geo/Swan_Canning_v4_ERZ.2dm';

shpfile = '../modeltools/gis/swan_erz_subbox.shp';
...
for i = 1:length(X)
    ...
    for jj = 1:length(shp)
        ...
        if inpol == 1
            ...
            original_val = shp(jj).Plot_Order;
%             if mat_val == 1
%                 
