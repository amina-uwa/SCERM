function create_interpolated_BC_for_inflow_Bennet(swan,headers,datearray)
...
t_depth = swan.s616084.(varname).Depth;
tt = find(t_depth > -0.1);

[t_date,ind] = unique(swan.s616084.(varname).Date(tt));
t_data = swan.s616084.(varname).Data(tt(ind));
