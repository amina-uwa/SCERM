function create_interpolated_BC_for_inflow_Susannah(swan,headers,datearray)
...
t_depth = swan.s616099.(varname).Depth;
tt = find(t_depth > -0.1);

[t_date,ind] = unique(swan.s616099.(varname).Date(tt));
t_data = swan.s616099.(varname).Data(tt(ind));
